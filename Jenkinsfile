pipeline {
    ...
    stages {
        ...
        stage('Sonar Analysis') {
                steps {
                    sh "${SCANNER_HOME}/bin/Sonar-Scanner -Dsonar.java.binaries=target/classes -Dsonar.host.url=http://172.22.75.224:9000/ -Dsonar.login=squ_1194ae65e8baa7e4aa0dfb0e912044eb087f63fa -Dsonar.projectName=to-do-app -Dsonar.projectKey=to-do-app -Dsonar.sources=."
                }
            }
